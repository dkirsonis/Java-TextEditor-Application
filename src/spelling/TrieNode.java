 ...
 */
class TrieNode {
	private HashMap<Character, TrieNode> children; //character = letters in the array inside a node
	private String text; 	//the word the trie holds if it is flagged as a word
